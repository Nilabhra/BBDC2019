...
if __name__ == '__main__':
    ...
    data = joblib.load('data_adversarial_complete.pkl')
    ...
    model = HARNet()
    optimiser = torch.optim.Adam(model.parameters(), weight_decay=0.0003)
    ...
    challenge.to_csv('submission13.planb.csv', index=False)
